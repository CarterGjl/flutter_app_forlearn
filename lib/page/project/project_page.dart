...
import 'package:flutter_app_forlearn/entity/banner_entity.dart';
import 'package:flutter_app_forlearn/entity/project_entity.dart';
import 'package:flutter_app_forlearn/entity/project_type_entity.dart';
import 'package:flutter_app_forlearn/entity/todo_entity.dart';
...
import 'package:flutter_app_forlearn/page/project/block/ProjectEvent.dart';
import 'package:flutter_app_forlearn/page/project/block/project_state.dart';
...
import 'package:flutter_app_forlearn/res/my_images.dart';
...
import 'package:flutter_app_forlearn/views/flat_pagination.dart';
...
class _ProjectSubPageState extends State<ProjectSubPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProviderTree(
        blocProviders: [
          BlocProvider<ProjectBloc>(builder: (context) => projectBloc)
        ],
                                        ...
                                        .map<int, ProjectTypesModel>(
                                          ...
                                          return MapEntry(
                                            ...
                                            ProjectTypesModel(
                                              ...
                                              entity.name,
                                              Image.asset(
                                                MyImage.animals[index %
                                                    MyImage.animals.length],
                                                width: pt(40),
                                                height: pt(40),
                                              ),
                                            ),
