...
class LoginCard extends StatefulWidget {
  ...
  LoginCard({this.isLogining = false, this.mode = LoginMode.LOGIN});
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                Padding(padding: EdgeInsets.only(right: pt(16)),
                  child: Icon(
                    Icons.lock,
                    color: WColors.theme_color,
                  ),
                ...
                Expanded(child: TextField(
                  onSubmitted: (String str) {
                    if (widget.mode == LoginMode.REGISTER) {
                      FocusScope.of(context).requestFocus(pwdAgainFocus);
                    }
                  },
                  textInputAction: widget.mode == LoginMode
            ...
            AnimatedContainer(
              ...
              child:Offstage(
                offstage: widget.mode !=LoginMode.REGISTER,
                child: Padding(
                  padding: EdgeInsets.only(top: pt(0)),
                  child: Row(
                    children: <Widget>[
                      Padding(
                        padding: EdgeInsets.only(right: pt(16)),
